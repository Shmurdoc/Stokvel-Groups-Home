...
{
	public class DepositStatusController : Controller
	{
		private readonly IPaymentStatusRepository _paymentStatusRepository;

		public DepositStatusController(IPaymentStatusRepository paymentStatusRepository)
		{
		...
		public async Task<IActionResult> Create([Bind("PaymentStatusId,PaymentStatusName,PaymentStatesDescription")] DepositStatus paymentStatus)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("PaymentStatusId,PaymentStatusName,PaymentStatesDescription")] DepositStatus paymentStatus)
		{
		...
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> DeleteConfirmed(int id, DepositStatus paymentStatus)
		{
